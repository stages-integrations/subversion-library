...
public class ResourcePropertyTest {
    ...
    public void createCustomPropertyTest() {
        ...
        final ResourceProperty property = new ResourceProperty(ResourceProperty.Type.SUBVERSION_CUSTOM, name, value);

        Assert.assertNotNull("property must not be null", property);
        Assert.assertEquals("type is not SUBVERSION_CUSTOM", ResourceProperty.Type.SUBVERSION_CUSTOM, property.getType());
