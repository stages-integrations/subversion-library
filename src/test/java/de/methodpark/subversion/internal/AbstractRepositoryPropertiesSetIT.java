...
public abstract class AbstractRepositoryPropertiesSetIT {
    ...
    public void test02_overrideProperties() throws Exception {
        ...
        AbstractRepositoryAddIT.file(repository, resource, "test", true);
        final ResourceProperty property = new ResourceProperty(ResourceProperty.Type.SUBVERSION_CUSTOM, "test", "A");
        setProperties(repository, resource, property);

        final ResourceProperty newProperty = new ResourceProperty(ResourceProperty.Type.SUBVERSION_CUSTOM, "new", "new");
        final ResourceProperty existingProperty = new ResourceProperty(ResourceProperty.Type.SUBVERSION_CUSTOM, "test", "B");
    ...
    public void test03_subversionProperties() throws Exception {
        ...
        AbstractRepositoryAddIT.file(repository, resource, "test", true);
        final ResourceProperty eolProperty = new ResourceProperty(ResourceProperty.Type.SUBVERSION_SVN, "eol-style", "native");
        final ResourceProperty executableProperty = new ResourceProperty(ResourceProperty.Type.SUBVERSION_SVN, "executable", "*");
        final ResourceProperty keywordsProperty = new ResourceProperty(ResourceProperty.Type.SUBVERSION_SVN, "keywords", "Author Id");
        final ResourceProperty mimeProperty = new ResourceProperty(ResourceProperty.Type.SUBVERSION_SVN, "mime-type", "text/plain");
