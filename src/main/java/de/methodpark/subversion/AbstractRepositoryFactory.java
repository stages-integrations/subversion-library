 ...
 */
package de.methodpark.subversion;
...
/**
 * {@link AbstractRepositoryFactory} creates a new {@link Repository}.
 */
@ThreadSafe
public abstract class AbstractRepositoryFactory {
    ...
    /**
     * Create a new {@link AbstractRepositoryFactory} instance each time the method is called.
     *
     * @return the new {@link AbstractRepositoryFactory} instance
     *
     * @throws SubversionException
     *             if no {@link AbstractRepositoryFactory} can be created
     */
    public static AbstractRepositoryFactory getInstance() throws SubversionException {
        for (final AbstractRepositoryFactory factory : ServiceLoader.load(AbstractRepositoryFactory.class)) {
            return factory;
        }
